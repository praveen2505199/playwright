...
async function ValidateSchedule10dataforVirginia(page, base)
{
    ...
    await searchInput.fill('Schedule 10 Data');
   ...
   // await base.handleFeedbackModal();
    ...
    console.log("Step 2: Navigates to Schedule 10 data page in Virginia");
    if (currentUrl.includes('/virginia/rates-and-tariffs/schedule-10-data')) {
        console.log("Virginia - Schedule 10 Datapage loaded successfully:", currentUrl);
    } else {
